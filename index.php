...
<!-- <link rel="shortcut icon" type="image/png" href="..assests/img/logo.jpg"> -->
    ...
    <body id="page-top">
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">PVR ICON Pavilion</a>
       ...
       ?>
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2022 PVR ICON Pavilion</div></div>
        </footer>
